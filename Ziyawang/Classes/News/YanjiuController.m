...
#import "NewsModel.h"
@interface YanjiuController ()<UITableViewDelegate,UITableViewDataSource,MBProgressHUDDelegate>
...
@implementation YanjiuController
...
- (void)getNewsList
{
    ...
    [dic setObject:@"hyyj" forKey:@"NewsLabel"];
