...
@property (nonatomic,strong) NSString *BuyerNature;
@property (nonatomic,strong) NSString *Rate;
@property (nonatomic,strong) NSString *Requirement;
@property (nonatomic,strong) NSString *Informant;
...
@property (nonatomic,strong) NSString *VideoLogo;
@property (nonatomic,strong) NSString *VideoLink;
@property (nonatomic,strong) NSString *VideoLink2;
