...
- (void)viewDidLoad {
    ...
    switch (self.vipType.integerValue) {
        case 1:
            ...
            self.label1.text = @"在会员期间内，可免费查看本网站所有资产包类VIP和收费信息以及所有付费视频。";
        ...
        case 2:
            ...
            self.label1.text = @"在会员期间内，可免费查看本网站所有企业商账类VIP和收费信息以及所有付费视频。";
        ...
        case 3:
            ...
            self.label1.text = @"在会员期间内，可免费查看本网站所有固定资产类VIP和收费信息以及所有付费视频。";
            self.label2.text = @"按办理会员的价格赠送芽币（例：月度会员6498元赠送6498芽币）。可方便您查看其他类型信息。";
        ...
        case 4:
            ...
            self.label1.text = @"在会员期间内，可免费查看本网站所有融资信息类VIP和收费信息以及所有付费视频。";
        ...
        case 5:
            ...
            self.label1.text = @"在会员期间内，可免费查看本网站所有个人债权类VIP和收费信息以及所有付费视频。";
            self.label2.text = @"按办理会员的价格赠送芽币（例：季度会员998元赠送998芽币，年度会员2998元赠送2998芽币）。可方便您查看其他类型信息。";
              self.label4.text = @"升级为会员后，您服务方的展示页面联系方式将公开，会有更多用户第一时间主动联系您";
            break;
