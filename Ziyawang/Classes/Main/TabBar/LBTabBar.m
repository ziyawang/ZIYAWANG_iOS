...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [self setBackgroundImage:[UIImage imageWithColor:[UIColor blackColor]]];

        self.backgroundColor = [UIColor blackColor];
//        [self setShadowImage:[UIImage imageWithColor:[UIColor blackColor]]];

        UIButton *plusBtn = [[UIButton alloc] init];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"xinfabu"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"xinfabu"] forState:UIControlStateHighlighted];
