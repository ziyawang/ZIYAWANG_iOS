...
+ (void)createPopMenuItems:(NSArray *)items
    ...
    HcdPopMenuView *menu = [[HcdPopMenuView alloc]initWithItems:items View:self];
//    HcdPopMenuView *menu = [[HcdPopMenuView alloc]initWithItems:items View:self];
...
//+ (void)createPopmenuItems:(NSArray *)items View:(UIView *)view
//            closeImageName:(NSString *)closeImageName
//        backgroundImageUrl:(NSString *)urlStr
//                    tipStr:(NSString *)tipStr
//           completionBlock:(selectCompletionBlock)block {
//    
//    HcdPopMenuView *menu = [[HcdPopMenuView alloc]initWithItems:items View:view];
//    //    [menu setBgImageViewByUrlStr:urlStr];
...
//        [self setFrame:CGRectMake:self.window.frame];
...
//        [self showWithView:view];
        ...
        //初始化设置 退出小按钮
        _exitView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 20, 20)];
        CGPoint center = CGPointMake([UIScreen mainScreen].bounds.size.width/2, [UIScreen mainScreen].bounds.size.height - kBottomViewHeight -30);
        _exitView.center = center;
        _exitView.transform = CGAffineTransformMakeRotation(M_PI_2/2);
//        [self.blurView addSubview:_exitView];
...
//    self.alpha = 0.3;
    ...
    self.blurView.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0];
...
- (void)initUI {
    ...
    if (version >= 8.0) {
        ...
        [blurView setBackgroundColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:0.0f]];
    } else if (version >= 7.0) {
...
//    _window.backgroundColor = [UIColor clearColor];
    _window.backgroundColor = [[UIColor blackColor]colorWithAlphaComponent:0];

    self.backgroundColor = [UIColor clearColor];
    //    self.alpha = 0.3;
//    self.backgroundColor = [[UIColor whiteColor]colorWithAlphaComponent:0];
//    self.blurView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.5];
//    self.blurView.backgroundColor = [UIColor blackColor];
    self.blurView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];
